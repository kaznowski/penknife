...
public static class TransformExtension
{
    ...
    */
    ...
    public static void RotateToDirection(this Transform transform, Vector3 direction, Vector3 rotateAxis)
    {
        transform.rotation = Quaternion.FromToRotation(rotateAxis, direction) * transform.rotation;
    }
    ...
    */
    ...
    public static void FullFill(this RectTransform transform)
    {
        if (transform == null)
            return;
        transform.localScale = Vector3.one;
    ...
    public static bool InsideOfCollider(this Transform self, Collider2D collider)
    {
        return collider.OverlapPoint(self.position);
    }
}
