...
namespace DoubleDash.CodingTools.LocalNotifications
{
    ...
    public class iOSNotification : INotification
    {
        ...
        public string Body
        {
            ...
            set => _internalNotification.Body = value;
        }
        ...
        public string Subtitle
        {
            ...
            set => _internalNotification.Subtitle = value;
        }
        ...
        public DateTime? DeliveryTime
        {
            get
            {
                if (!(InternalNotification.Trigger is Unity.Notifications.iOS.iOSNotificationCalendarTrigger
                        calendarTrigger))
                {
                    return null;
                }
        ...
        /// <summary>
        /// Instantiates a new instance of iOSNotification with InternalNotification equal to internalNotification.
        /// </summary>
        /// <param name="internalNotification">The internal notification.</param>
        public iOSNotification(Unity.Notifications.iOS.iOSNotification internalNotification)
        {
