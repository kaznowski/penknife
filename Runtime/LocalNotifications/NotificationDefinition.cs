...
namespace DoubleDash.CodingTools.LocalNotifications
{
    ...
    public class NotificationDefinition : ScriptableObject
    {
        ...
        [Tooltip("Devo esperar a aplicação perder focus para agendar a notificação?" +
                 " O Game Event ainda precisará ser engatilhado.")]
        [SerializeField]
        private bool _waitLoseFocus = true;

        [Tooltip("Título exibido na notificação.")] [SerializeField]
        ...
        [Tooltip("A notificação deverá ser agendada para daqui a quantos minutos?")] [SerializeField]
        private double _timeTrigger;

        [Tooltip("Devo forçar que a notificação seja agendada dentro de uma faixa de horário?")] [SerializeField]
        ...
        [Tooltip("A notificação deve se repetir periodicamente?")] [SerializeField]
        ...
        private WaitLoseFocusBehaviour _waitLoseFocusBehaviour;
        ...
        public async void ScheduleNotification()
        {
            ...
            if (_waitLoseFocus)
            {
                await WaitLoseFocusBehaviour.WaitLoseFocus();
            }
        ...
        private void SetNotificationText(INotification notification)
        {
            ...
            notification.Subtitle = _subtitle;
